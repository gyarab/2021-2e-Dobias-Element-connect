        ...
        labelsBtn.setOnAction(e -> {
            ...
            if (labelsBtn.isSelected() == true) {
                ...
                if (water == true) {
                    ...
                    gridPane1.getChildren().remove(waterL);
                }
                if (fire == true) {
                    pane.getChildren().remove(fireL);
                } else {
                    gridPane1.getChildren().remove(fireL);
                }
                if (air == true) {
                    pane.getChildren().remove(airL);
                } else {
                    gridPane1.getChildren().remove(airL);
                }
                if (earth == true) {
                    pane.getChildren().remove(earthL);
                } else {
                    gridPane1.getChildren().remove(earthL);
                }
                if (steam == true) {
                    pane.getChildren().remove(steamL);
                } else {
                    gridPane1.getChildren().remove(steamL);
                }
                if (dust == true) {
                    pane.getChildren().remove(dustL);
                } else {
                    gridPane1.getChildren().remove(dustL);
                }
                if (glass == true) {
                    pane.getChildren().remove(glassL);
                } else {
                    gridPane1.getChildren().remove(glassL);
                }
                if (lava == true) {
                    pane.getChildren().remove(lavaL);
                } else {
                    gridPane1.getChildren().remove(lavaL);
                }
                if (iron == true) {
                    pane.getChildren().remove(ironL);
                } else {
                    gridPane1.getChildren().remove(ironL);
                }
                if (sand == true) {
                    pane.getChildren().remove(sandL);
                } else {
                    gridPane1.getChildren().remove(sandL);
                }
            }
